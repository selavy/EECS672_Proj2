...
void BoardMV::sendMatrices()
{
  ...
  glUniformMatrix4fv( BoardMV::ppuLoc_WCECMatrix, 1, GL_TRUE, &_wcec[0] );
  glUniformMatrix4fv( BoardMV::ppuLoc_ECLDSMatrix, 1, GL_TRUE, &_orthogonal[0] );
}
...
#ifdef __DEBUG__
      std::cout << eyelimits[i] << " " << eyelimits[i+1] << std::endl;
#endif
    }
